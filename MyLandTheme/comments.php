...
<div id="comments" class="comments-area">
    ...
    ?>
            ...
            ?>
                    <p class="no-comments"><?php esc_html_e("Comments are closed.", 'landtheme');?></p>
            <?php
                endif;
            ?>
    ...
    <?php
        ...
        $args = array(
                ...
                'comment_field' => '<div class="form-group"><label for="comment">' . _x( 'Comment', 'noun' ) . '</label> <span class="required">*</span><textarea id="comment" class="form-control" name="comment" rows="4" required="required"></textarea></p></div>',
